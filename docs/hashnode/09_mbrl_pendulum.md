...
subtitle: "Why do standard RL agents require 10,000 crashes to learn how to fly? We explore the massive paradigm shift of Model-Based RL (MBRL), where an AI learns the laws of physics and hallucinates the future before taking a single step."
slug: mbrl-pendulum
tags: machine-learning, python, artificial-intelligence, data-science
cover: "https://raw.githubusercontent.com/Dash10107/reinforcement-learning-lab/main/assets/mbrl_pendulum_cover.png"
